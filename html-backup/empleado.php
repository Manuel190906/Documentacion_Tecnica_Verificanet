...
FROM incidencias 
WHERE id_empleado_asignado = ?  -- <--- CAMBIADO DE id_empleado A id_empleado_asignado
");
    ...
    <div class="dashboard-container">
        ...
        <?php if (isset($_GET['accion']) && $_GET['accion'] === 'nueva'): ?>
            ...
            <div style="background: #fff3cd; border-left: 4px solid #ffc107; padding: 15px; margin: 20px 0; border-radius: 4px;">
                <h3 style="margin: 0 0 10px 0;">💡 ¿Tienes un problema?</h3>
                <p style="margin: 0 0 15px 0;">Antes de crear una incidencia, consulta nuestros manuales. Muchos problemas tienen solución inmediata.</p>
                <a href="manuales.php" style="background: #007bff; color: white; padding: 10px 20px; text-decoration: none; border-radius: 4px; display: inline-block;">
                    🔍 Consultar Manuales de Ayuda
                </a>
            </div>
